...
function render(main) {
  ...
  main.innerHTML = `
    ...
    <div class="dashboard-card" style="margin-bottom: var(--space-xl);">
      ...
      <p style="margin-bottom: var(--space-m);">1. Download the desktop app from the <a href="${base}/download/">Download</a> page.</p>
      <p style="margin-bottom: var(--space-m);">2. Create an account or sign in on this website.</p>
    ...
    <div class="dashboard-card" style="margin-bottom: var(--space-xl);">
      ...
      <p style="margin-bottom: var(--space-m);">1. Click the BrainDock icon in the menu bar (macOS) or system tray (Windows).</p>
      <p style="margin-bottom: var(--space-m);">2. Choose your mode: Camera, Screen, or Both.</p>
    ...
    <div class="dashboard-card" style="margin-bottom: var(--space-xl);">
      ...
      <p style="margin-bottom: var(--space-m);">Go to <a href="${base}/settings/blocklist/">Settings → Blocklist</a> to choose which sites and apps count as distractions during screen monitoring.</p>
      <p style="margin-bottom: var(--space-m);">Use Quick Block toggles for common sites (e.g. Instagram, YouTube). Enable whole categories (Social Media, Video Streaming, etc.) or add custom URLs and app names.</p>
